...
export const TodayStaus = () => {
  ...
  return (
    <div className="bg-gradient-to-t  from-[#0E1421] via-[#1d325f4c]  to-[#0E1421] p-6  text-white rounded-2xl  shadow-sm shadow-cyan-500 hover:shadow-blue-600 hover:shadow-m">
      ...
      <div className="grid grid-cols-2 grid-rows-2 gap-4 mt-3 ">
        ...
        <div className="bg-white/5 p-6 rounded-lg  shadow-sm shadow-cyan-500 hover:shadow-blue-600 hover:shadow-m">
          ...
          <div className="lex flex-col md:flex-row lg:flex-row justify-between gap-3">
            <div className="h-28">
              <img src={presure_img} className="h-full w-full" alt="" />
            </div>
            <div className="flex justify-end flex-col">
